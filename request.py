...
img = image.img_to_array(image.load_img(image_path, target_size=(512, 512))) / 511.
...
r = requests.post('http://localhost:9000/v1/models/facemask_model:predict', json=payload)
